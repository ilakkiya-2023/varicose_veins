...
const Teleconsultation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("⚠️ Booking saved locally, but failed to send emails. Check console.");
    } finally {
      setSending(false);
    }
  };
      ...
      <div className="teleconsultation-content">
        ...
        <div className="card-grid">
          <div className="doctor-card general">
            <img
              src={generalConsultation.image}
              alt={generalConsultation.name}
            ...
            <p>
              <strong>Experience:</strong> {generalConsultation.experience} yrs
            </p>
            <p>
              <strong>Specialization:</strong> {generalConsultation.specialization}
            </p>
            <p>
              <strong>Availability:</strong> {generalConsultation.availability}
            </p>
            <button
              className="btn"
              onClick={() => handleBookClick(generalConsultation)}
            >
              Book Appointment
            </button>
          </div>
        ...
        {selectedDoctor && (
          <div className="modal-overlay" onClick={() => setSelectedDoctor(null)}>
            ...
            >
              ...
              {selectedDoctor.id === 0 && (
                <p className="note">
                  This booking is for a general consultation. You will meet a general physician.
                </p>
              )}
              ...
              <form onSubmit={handleSubmit} className="booking-form">
                ...
                <input
                  type="email"
                  name="patientEmail"
                  placeholder="Patient Email (for confirmation)"
